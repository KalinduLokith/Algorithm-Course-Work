 ...
 * Email  : kalindu.20210332@iit.ac.lk
 * IIT ID : 20210332
 */
public class AcyclicEncounter
{
    /**
     * This technique detects whether a directed graph has cycles or not.
     * If the graph is acyclic, it returns true; if not, it returns false.
     * @param graph examine the directed graph for acyclicity.
     * @return if the graph is acyclic, then true, otherwise false
     */
